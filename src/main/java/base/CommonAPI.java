...
public class CommonAPI {
    ...
    String username = Utility.getProperties().getProperty("browserstack.username");
    String password = Utility.getProperties().getProperty("browserstack.password");
    ...
    public void clickOnAnElementThatContainSpecificTextInList(List<WebElement> elements, String str){
